...
## Thèse courante
**ATTENDRE** — Score Opportunité ~5,1/10 (ajusté Qualité + options + sectoriel), Score Global ~51/100 (2026-05-20 snapshot 13:00 UTC)

Thèse d'investissement : FUBO est un titre spéculatif du secteur Communication Services (streaming sportif live) avec un profil fondamental dégradé (Score Qualité 1/6, FCF négatif, current ratio 0,84, debt/equity 2,43). La divergence Yahoo/FMP persiste (market cap $270,8M vs ~$3,27B — ×12,1), rendant toute valorisation fiable impossible. Le momentum technique est baissier (close $9,20, sous MM50 à $11,79, RSI 32,26 proche survente, volume 0,69× moyenne 20j — liquidité réduite). L'anomalie data quality sur le max pain observée ce matin ($21,00) est **résolue dans le snapshot 13:00 UTC** : le max pain est revenu à $10,00 (cohérent avec l'historique). Le put/call est à 0,59, le call OI dominant à 62,9% (+2,3 pp) — signalant un intérêt spéculatif haussier renforcé combiné au short interest massif (22,84%). Ce setup dessine un potentiel short squeeze technique, mais sans fondement qualitatif ; le spot à $9,20 s'écarte de 8,0% sous le max pain validé ($10,00), laissant entrevoir un rebond technique de pinning à J-1/J-0 (2026-05-21/22). Le secteur Communication Services (XLC) reste classé bottom 3 de la rotation sectorielle (momentum 0,0). Les résultats Q1 2026 sont attendus le **2026-05-20** (JOUR J) mais ne sont pas visibles dans le snapshot 13:00 UTC — publication post-close probable ou retard API. **Pas de position longue recommandée.**
