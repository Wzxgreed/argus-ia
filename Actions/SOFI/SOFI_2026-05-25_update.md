...
**Date :** 2026-05-25 (snapshot 21:00 UTC — stabilité totale confirmée vs 17:00 UTC)
**Type :** `_update.md` — Confirmation post-session finale
...
| Métrique | `_update.md` 2026-05-25 (17:00 UTC) | **Snapshot 2026-05-25 (21:00 UTC)** | **Δ** |
|----------|-------------------------------------|-------------------------------------|-------|
...
| Max Pain options | $15.00 | **$15.00** | **$0.00** |
| Put/Call ratio | 0.75 | **0.75** | **0.00** |
| Call OI % | 57.2% | **57.2%** | **0.0 pts** |
| 52W range | $12.86–$32.73 | **$12.86–$32.73** | Inchangé |
| Earnings J | 64 | **64** | 0j |

**Verdict : Stabilité totale.** Le snapshot 21:00 UTC confirme l'intégralité des données du snapshot 17:00 UTC. Le marché américain était fermé ce jour (Memorial Day 2026-05-25). Aucune transaction électronique significative n'a altéré les niveaux techniques, fondamentaux ou options de SOFI entre les deux snapshots.

---

## 2. Mise à jour technique

| Indicateur | Valeur 2026-05-25 (21:00 UTC) | Signal |
|------------|-------------------------------|--------|
| RSI 14j | 43.83 | 🟡 Zone neutre — inchangé depuis 17:00 UTC |
...
| Volume relatif | 0.84× | 🟡 En retrait — marché fermé |
| Beta | 2.126 | ⚠️ Volatilité extrême — sizing réduit obligatoire |

**Options (snapshot 2026-05-25 21:00 UTC) :**

| Métrique | Valeur | Signal |
|----------|--------|--------|
| Max Pain | $15.00 | ⚠️ Sous le cours ($15.62) — attraction gravitationnelle marginale vers le bas |
| Put/Call ratio | 0.75 | 🔴 Rebalancement net vers les puts (stable vs 17:00 UTC) |
| Call OI % | 57.2% | 🟡 Skew call réduit (stable vs 17:00 UTC) |
| Expiration prochaine | 2026-05-29 (4 jours) | Risque de pinning autour de $15.00–$15.50 inchangé |

> **Interprétation :** La configuration technique est figée à la clôture du 22/05 (dernière session avant le weekend de Memorial Day). Aucun nouveau flux de prix n'a été généré ce jour. Les niveaux restent identiques : cours sous MM50, RSI neutre sans momentum haussier, support psychologique $15.00 tenu. L'expiration options du 2026-05-29 (4 jours ouvrés) approche — le pinning vers Max Pain $15.00 reste le risque dominant à très court terme.
...
| Ratio | Valeur _init.md (17/05) | Valeur 2026-05-25 (21:00 UTC) | Δ |
|-------|-------------------------|-------------------------------|---|
...
> **Note :** Marché fermé = aucun mouvement de multiples. Les fondamentaux sous-jacents sont inchangés.
...
- **Put/Call ratio :** 0.75 — stable vs snapshot 17:00 UTC. Signal défensif à très court terme inchangé.
- **Call OI % :** 57.2% — stable vs snapshot 17:00 UTC.
- **Interprétation :** Aucun repositionnement options n'a eu lieu entre 17:00 et 21:00 UTC (marché fermé). Le risque de pinning vers $15.00 à l'expiration du 2026-05-29 persiste.

### News & Social
- **Aucune mention Reddit** (`social_sentiment_latest.json` : 0 mentions, score 0/10).
- **Aucune news SOFI** (`news_2026-05-25.json` : 0 item).
- **Aucun événement corporate** (`events_latest.json` : 0 événement SOFI).
- **Aucune alerte géopolitique** (`geo_risk_latest.json` : SOFI geo_risk_score 2, non exposé, flag 🟢).
...
### Données agents actualisées (`recommandations_latest.json` — 2026-05-25 21:00 UTC)
...
**Évolution vs snapshot 17:00 UTC :** Inchangé. Score Opportunité **5.7/10**, Score Global **48.6/100 (SURVEILLER)**. Le régime macro reste indéterminé dans le système ("Unknown"), pondération par défaut 35/40/25 appliquée.
...
| Malus Geo | 0 | geo_risk_score 2, non exposé = faible |
...
> **Note :** Aucun changement de score entre le snapshot 17:00 UTC et 21:00 UTC. La classification SURVEILLER est confirmée pour le close final du jour.

---

## 6. Révision des niveaux SL / TP

| Niveau | Ancien (17:00 UTC) | Révisé 2026-05-25 (21:00 UTC) | Justification |
|--------|--------------------|-------------------------------|---------------|
...
**Verdict technique :** Les niveaux SL/TP restent inchangés par rapport au snapshot 17:00 UTC. L'ATR compressé à $0.64 resserre la fourchette de risque : SL à **$14.34**, TP à **$17.54**. Le ratio R/R reste à 1.50. Le support critique est le niveau psychologique **$15.00**. Un break sous $15.00 ouvre $14.34 (SL) puis le 52W low $12.86. La MM50 $16.76 et la zone $16.00 restent les résistances clés.

---

## 7. Conclusion — Thèse confirmée, modifiée ou invalidée ?

**Verdict : THÈSE CONFIRMÉE — Aucune mutation (marché fermé Memorial Day, snapshot final 21:00 UTC).**

La thèse fondamentale et technique reste inchangée entre le snapshot 17:00 UTC et 21:00 UTC :

1. **Cours stable à $15.62** — Marché fermé, aucun nouveau flux de prix.
...
4. **Signal options défensif inchangé** — Put/Call 0.75, Call OI % 57.2%. Risque de pinning vers $15.00 à l'expiration du 29/05.
5. **Aucun catalyseur immédiat** — Earnings Q2 dans 64j (2026-07-28), consensus stable, pas de news structurante.
6. **Sector headwind inchangé** — XLF momentum 0.0/10, return 20j +1.01%. Le secteur financier reste sans direction.
7. **Qualité partielle inchangée** — 4/6, FCF négatif, ROE faible, dépendance aux taux.
8. **Score Global 48.6/100 (SURVEILLER)** — Confirmé stable pour le close final du 25 mai.
9. **Exposition FX neutre** — fx_impact_score 0.0, flag 🟢.
10. **Social sentiment neutre** — 0 mentions Reddit, pas de pump/dump détecté.
11. **Risque géopolitique faible** — geo_risk_score 2, non exposé, flag 🟢.
...
- Thèse résumée : Snapshot 21:00 UTC confirme stabilité totale vs 17:00 UTC (marché fermé Memorial Day). Cours $15.62, RSI 43.83, MM50 $16.76, ATR $0.64. Put/Call 0.75, Call OI 57.2% = signal défensif stable. Score Global 48.6/100 (SURVEILLER). TP $17.54, SL $14.34, R/R 1.50. Earnings dans 64j. Support critique $15.00. Aucune news, aucun événement corporate, exposition FX et géo neutres. Accounting risk non évalué (fichier absent).
...
- `Actions/SOFI/SOFI_2026-05-20_update.md` — Mise à jour quotidienne (snapshot 13:00 UTC, données options corrigées)
- `Actions/SOFI/SOFI_2026-05-25_update.md` — Mise à jour quotidienne (snapshot 10:00 UTC — close final confirmé $15.62)
- `Actions/SOFI/SOFI_2026-05-25_update.md` — Mise à jour quotidienne (snapshot 17:00 UTC — confirme stabilité vs 10:00 UTC)
- `Actions/SOFI/SOFI_2026-05-25_update.md` — Ce fichier (snapshot 21:00 UTC — confirme stabilité totale vs 17:00 UTC)
- `data/latest.json` (2026-05-25T21:00:08+00:00) — Cours, RSI, ATR, consensus, ratios FMP, options
- `data/recommandations_latest.json` (2026-05-25) — Scores agents actualisés
- `data/quant_report_latest.json` — Insuffisant
- `data/geo_risk_latest.json` — geo_risk_score 2, non exposé
...
- `data/upcoming_events_latest.json` — Earnings 2026-07-28 (64j)
- `data/events_latest.json` — Aucun événement corporate
- `data/news_2026-05-25.json` — 0 news SOFI
