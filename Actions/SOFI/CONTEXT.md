...
- **Nouvelle vigilance :** Volume <0.7× sur prochaine session = révision timing → Défavorable
...
- **Fichier :** `SOFI_2026-06-22_update_17h00.md`
- **Conclusion :** Retrait −3.46% sur volume effondré 0.52×. RSI 41.95, reclaim MM50 rétréci +1.94%. Anomalie options résolue. Score Global 63.3/100 (ACHETER Réduit au bord inférieur). Vigilance accrue sur volume.

---

## 🔄 Triggers détectés (full refresh)

- **ATR_SPIKE** (medium) — ATR relatif 5.78% (seuil 5.0%) — archivé faux positif
