# NOK — Mise à Jour Quotidienne (2026-05-25, Snapshot 21:00 UTC)

> Desk : Argus-IA | Ticker : NOK (NYSE ADR) | Secteur : Technology / Communication Equipment
> Date analyse : 2026-05-25 | Données source : `data/latest.json` (snapshot 2026-05-25T21:00:08 UTC)
...
| Put/Call ratio | 0.41 | **0.41** | 0.00 | Stable |
| Max pain options | $14.00 | **$14.00** | $0.00 | Stable |
| Call OI | 70.9% | **70.9%** | 0.0 pp | Stable |

**Changements significatifs détectés :**
- **Aucun.** Le snapshot 21:00 UTC reproduit strictement les mêmes données que le snapshot 17:00 UTC. Aucune mutation technique, fondamentale ou options post-clôture US.
...
|----------|--------|--------|-------------|
| Cours close | $15.47 | Yahoo Finance | +9.1% vs previous close ($14.18), inchangé vs 17:00 UTC |
| Open | $14.70 | Yahoo Finance | Gap haussier d'ouverture, inchangé |
| High intraday | $15.78 | Yahoo Finance | **Nouveau 52-week high**, inchangé |
...
**Niveaux clés (inchangés vs 17:00 UTC) :**
...
**Verdict timing :** Favorable sur le momentum pur — inchangé. Le cours est au-dessus de la MM50 avec un écart significatif (+43.2%), le volume est revenu à la normale, et l'options flow est bullish. Cependant, le RSI à 64.29 approche la zone de surachat (>70) sans catalyseur fondamental identifiable, ce qui fragilise la durabilité du mouvement.
...
**Note fondamentale :** Aucune donnée fondamentale nouvelle entre 17:00 et 21:00 UTC. L'expansion du multiple P/E à 96.69 sur un consensus inchangé à $9.26 maintient la divergence entre prix et valeur. Le forward P/E à 31.72 reste élevé pour une entreprise à croissance limitée et quality hors périmètre.
...
**⚠️ Attention :** Le SL à $13.51 reste très proche du support intraday ($14.58). Un retour sous $14.00 (max pain) confirmerait une inversion technique rapide. Le gap de +9.1% sans catalyseur rend le titre vulnérable à un retour de moyenne.
...
**Verdict :** La thèse est **confirmée** — aucune mutation entre le snapshot 17:00 UTC et le snapshot 21:00 UTC.

**Analyse :**
- Les données du snapshot 21:00 UTC sont **strictement identiques** au snapshot 17:00 UTC (close $15.47, RSI 64.29, ATR $0.98, volume 1.07×, options inchangées).
- Aucune nouvelle post-clôture US, aucun événement corporate, aucun mouvement options/insiders.
- Le momentum haussier de +9.1% reste non expliqué par un catalyseur fondamental identifiable.

**Ce qui n'a pas changé :**
- **Technique :** RSI 64.29, ATR $0.98, volume 1.07×, options bullish (put/call 0.41, call OI 70.9%, max pain $14.0).
...
- **Sectoriel :** XLC (Communication Services) reste en sous-performance relative vs SPY.
...
**⚠️ Risque principal :** Gap haussier non expliqué = vulnérable à un retour de moyenne rapide si le catalyseur (s'il existe) n'est pas confirmé. Le max pain options à $14.00 offre un premier support psychologique.
