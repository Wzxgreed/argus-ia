# CONTEXT — NOK — Dernière mise à jour : 2026-06-03 13:00 UTC
...
- **Date :** 2026-06-03
- **Type :** update
- **Fichier :** `NOK_2026-06-03_update.md`
- **Conclusion :** Stabilité totale vs snapshot 10h. Anomalie options résolue (max pain $13.50 restauré). Pin risk extrème confirmé à J-2 expiration. Thèse ÉVITER 31.8/100 confirmée.

---

## 🔄 Triggers détectés (full refresh)

- **ATR_SPIKE** (medium) — ATR relatif 6.05% (seuil 5.0%) — déjà traité, DRAFT_refresh archivé
