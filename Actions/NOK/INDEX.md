...
| 2026-06-02 | Update (10:00 UTC) | [NOK_2026-06-02_update.md](./NOK_2026-06-02_update.md) | Snapshot 10:00 UTC : aucune mutation vs 21h 01/06. Cours **$16.25** inchangé, volume révisé **171.8M** (1.45×). Données options corrompues dans latest.json (max pain $2.00 aberrant) — valeurs opérationnelles $13.50 conservées. Pin risk extrême maintenu (expiration 05/06 dans 3 j). Score Global ajusté **50.5/100** — **ATTENDRE** confirmé. Thèse confirmée. |
...
**Stop-loss :** $14.17 (cours − 2×ATR)
**Take-profit :** $19.37 (cours + 3×ATR)
**Upside/Downside :** −43.0% / −12.8%
**Dernière mise à jour :** 2026-06-02 10:00 UTC

Snapshot 10h UTC : cours **$16.25** (strictement inchangé vs snapshot 21h 01/06), volume révisé **171.8M** (1.45× moyenne 20j) confirmant la participation élevée de la séance du 01/06. Le support $15.47 (cassé à $14.53 le 01/06 matin) reste totalement récupéré. Le high du jour ($16.52) teste la résistance avant le 52-week high ($16.63). Le cours défend quasi-intégralement le double gap du 25–26/05. RSI 62.59 (zone neutre haute, pas de surachat), ATR $1.04 (trigger ATR_SPIKE actif à 6.40%). Le cours reste +40.9% au-dessus de la MM 50j ($11.53) — tendance haussière structurelle intacte. **Cependant**, la valorisation reste extrême (P/E Yahoo 101.56, cours +75.5% vs consensus $9.26). **Données options corrompues dans `data/latest.json`** (max pain $2.00 aberrant, put/call et call OI nuls) — valeurs opérationnelles du snapshot 21h 01/06 conservées : max pain $13.50, put/call 0.46, call OI 68.5%, expiration 2026-06-05 (dans 3 jours). Le cours +20.4% au-dessus du max pain crée un **pin risk baissier extrême** — risque de mean-reversion vers $13.50 d'ici vendredi si aucun catalyseur n'intervient. Quality hors périmètre (2.5/6) : bilan solide (net cash, D/E 0.25) mais rentabilité anémique (ROIC 1.9%, operating margin 3.9%). Divergence structurelle Yahoo/FMP persistante (P/E FMP 45.81 vs Yahoo 101.56). Dividende 1.01%. Le secteur Communication Services (XLC) reste en sous-performance relative vs SPY (bottom 3, RS20d −6.21%). Le mouvement reste totalement idiosyncratique et fragile face à un rally non justifié. Thèse confirmée : la récupération technique est intacte mais l'entrée reste exclue (Score Global ajusté 50.5/100, seuil ACHETER ≥60). Pas de position.

**⚠️ Données options partielles** — `data/latest.json` retourne des valeurs aberrantes pour max pain ($2.00) et des nulls pour put/call ratio et call OI. Les valeurs opérationnelles du snapshot 21h 01/06 sont conservées. Cours, RSI, ATR, P/E, consensus disponibles.
...
| Date | Événement |
|------|-----------|
| 2026-06-05 | Expiration options — données Yahoo corrompues, max pain non fiable |
