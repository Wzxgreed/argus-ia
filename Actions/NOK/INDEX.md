...
**Dernière mise à jour :** 2026-06-02 21:00 UTC

Snapshot 21h UTC final : cours **$16.85** (+0.09% vs snapshot 17h, +3.7% vs previous close), volume **129.6M** (1.09× moyenne 20j, +31.0% vs 98.9M au snapshot 17h). **New 52-week high $17.11** confirmé. Le support $16.25 (close 13h) demeure le niveau clé à défendre. RSI **70.22** (🔴 zone surachat confirmée), ATR $1.02 (trigger ATR_SPIKE actif à 6.05%). Le cours reste +44.0% au-dessus de la MM 50j ($11.70) — tendance haussière structurelle intacte mais **surchauffée**. **La révision du volume à la hausse (1.09×) invalide la divergence baissière volume/prix identifiée à 17h** — le rally a été accompagné par une participation légèrement supérieure à la moyenne, techniquement plus sain. **Cependant**, la valorisation reste extrême (P/E Yahoo 105.31, cours +81.9% vs consensus $9.26). **Données options confirmées** : max pain **$13.50**, put/call **0.45**, call OI **69.1%**, expiration 2026-06-05 (**demain**). Le cours +24.8% au-dessus du max pain crée un **pin risk baissier extrême** — risque de mean-reversion vers $13.50 dès demain si aucun catalyseur n'intervient. Quality hors périmètre (2.5/6) : bilan solide (net cash, D/E 0.25) mais rentabilité anémique (ROIC 1.9%, operating margin 3.9%). Divergence structurelle Yahoo/FMP persistante (P/E FMP 45.81 vs Yahoo 105.31). Dividende 1.01%. Le secteur Communication Services (XLC) reste en sous-performance relative vs SPY (bottom 3, RS20d −7.97%). Le mouvement reste totalement idiosyncratique. `recommandations_latest.json` inchangé : Score Global ajusté **31.8/100** — **ÉVITER** (seuil <35). Thèse confirmée : surchauffe technique persistante (RSI 70) mais volume final plus sain qu'estimé à 17h. Absence de catalyseur fondamental. Pas de position.
