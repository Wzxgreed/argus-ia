# NOK — Mise à Jour Quotidienne (2026-06-01, Snapshot 21:00 UTC)

> Desk : Argus-IA | Ticker : NOK (NYSE ADR) | Secteur : Technology / Communication Equipment
> Date analyse : 2026-06-01 | Données source : `data/latest.json` (snapshot 2026-06-01T21:00:08 UTC)

---

## 1. Résumé des changements depuis l'analyse précédente (Snapshot 17:00 UTC)

| Indicateur | Snapshot 17:00 UTC | Snapshot 21:00 UTC | Variation | Signal |
|-----------|--------------------|--------------------|-----------|--------|
| Cours close | $16.175 | **$16.25** | **+0.46%** | → Stable post-clôture |
| RSI 14j | 62.29 | **62.59** | +0.30 | → Zone neutre haute |
| ATR 14j | $1.02 | **$1.04** | +2.0% | → Trigger ATR_SPIKE maintenu |
| Volume | 118,976,466 | **162,090,920** | **+36.3%** | 🔴 Inclusion after-hours élevée |
| Volume relatif | 1.03× | **1.37×** | +0.34× | 🔴 Au-dessus de la moyenne 20j |
| High intraday | $16.25 | **$16.52** | +1.7% | → Même session |
| Low intraday | $14.93 | **$14.93** | — | → Support du jour respecté |
| P/E (TTM Yahoo) | 101.09 | **101.56** | +0.47% | → Valorisation inchangée |
| Forward P/E | 33.17 | **33.32** | +0.45% | → Stable |
| Premium vs consensus $9.26 | +74.7% | **+75.5%** | +0.8pp | → Divergence inchangée |
| MM 50j | $11.52 | **$11.53** | +0.09% | → Tendance haussière intacte |
| **Max pain options** | $13.50 | **$13.50** | — | → Inchangé |
| **Put/Call ratio** | 0.46 | **0.46** | — | → Structure bullish |
| **Call OI** | 68.5% | **68.5%** | — | → Dominance call intacte |

**Changements significatifs détectés :**
- **🔴 Volume after-hours massif** : le volume total passe de 119.0M à 162.1M (+36.3%), portant le volume relatif de 1.03× à **1.37×** la moyenne 20j. Cela indique une activité post-clôture substantielle — probablement des ajustements de positions avant l'expiration options du 05/06.
- **→ Cours stable** : le close $16.25 est quasiment inchangé vs le snapshot 17h UTC ($16.175). Le high du jour atteint $16.52 en séance régulière. Aucun gap post-clôture.
- **→ Données techniques inchangées** : RSI 62.59, ATR $1.04, MM50 $11.53. Tous les niveaux restent dans les mêmes fourchettes.
- **→ Options inchangées** : max pain $13.50, put/call 0.46, call OI 68.5%, expiration 2026-06-05 (dans 4 jours). Le pin risk extrême reste la menace principale à court terme.
...
|----------|--------|--------|-------------|
| Cours close | $16.25 | Yahoo Finance | +0.46% vs snapshot 17h UTC |
| Open | $15.07 | Yahoo Finance | Gap haussier d'ouverture +1.55% |
| High intraday | $16.52 | Yahoo Finance | Nouveau test de résistance |
| Low intraday | $14.93 | Yahoo Finance | Support égal au low matinal |
| Volume | 162,090,920 | Yahoo Finance | **1.37× moyenne 20j** — participation élevée |
...
- **Support immédiat :** $15.47 (ancien support, testé comme résistance) / $14.93 (low du jour)
...
**Mise à jour options — inchangées mais risque maintenu :**
| Niveau | Valeur 17:00 UTC | Valeur 21:00 UTC | Interprétation |
|--------|------------------|------------------|----------------|
...
> **🔴 Pin risk extrême à l'expiration 05/06.** Le cours ($16.25) reste **+20.4% au-dessus du max pain** ($13.50). Le volume after-hours élevé (162M vs moyenne 118M) suggère des ajustements de positions avant l'expiration. Historiquement, le max pain attire le cours à l'expiration. Avec 4 jours restants, la pression de mean-reversion vers $13.50 reste élevée en l'absence de catalyseur.
...
**Note fondamentale :** Aucune donnée fondamentale nouvelle. Le consensus inchangé à $9.26 sur 6 analystes maintient la divergence à **+75.5%** (vs +74.7% au snapshot 17h). Aucun upgrade, downgrade ou révision d'estimations n'a été détecté.
...
**Score Catalyseur :** 4.0/10 — inchangé dans `recommandations_latest.json`. Aucun catalyseur identifiable ; earnings éloignés (52 jours).
...
|--------|--------------------|---------------------|---------------|
| Stop-loss | $14.14 | **$14.17** | Révisé — ATR 2× ($16.25 − $2.08) |
| Take-profit | $19.23 | **$19.37** | Révisé — ATR 3× ($16.25 + $3.12) |
| Prix cible (consensus) | $9.26 | $9.26 | Inchange — 6 analysts, silence total |
| Upside consensus | −42.7% | **−43.0%** | Dégradé mécanique (cours plus haut) |
| Downside SL | −12.6% | **−12.8%** | Stable |

**⚠️ Attention :** Le cours ($16.25) est revenu au-dessus du support $15.47 et approche le 52w high ($16.63). Si le cours casse $16.52 en clôture avec volume, le test du 52w high ($16.63) devient probable à court terme. Inversement, si le cours clôture sous $15.47, le faux breakout haussier du jour sera confirmé et le risque de retour vers $14.17 (SL) puis $13.50 (max pain) augmente. Le **pin risk options ($13.50, expiration 05/06)** reste la menace principale à court terme.
...
**Verdict :** La thèse est **confirmée** — le snapshot 21:00 UTC ne révèle aucune mutation significative par rapport au snapshot 17:00 UTC. La recommandation reste **ATTENDRE** (Score Global ajusté 50.5/100). L'entrée reste exclue.

**Analyse :**
- **Technique :** Cours stable $16.25 (+0.46% vs 17h UTC). Le high du jour ($16.52) teste la résistance avant le 52w high ($16.63). RSI 62.59 (pas de surachat). ATR $1.04 (trigger ATR_SPIKE actif à 6.40%). Volume 162.1M (1.37×) — inclusion after-hours élevée, signalant des ajustements de positions pré-expiration. Le cours reste +40.9% au-dessus de la MM50 ($11.53) — tendance haussière structurelle intacte.
- **Options :** Max pain $13.50, put/call 0.46, call OI 68.5%, expiration 2026-06-05 (dans 4 jours). Le cours +20.4% au-dessus du max pain crée un **pin risk baissier extrême** à l'expiration. La structure call-dominated est bullish historiquement mais la divergence cours/max pain est dangereuse.
- **Volume :** 162.1M (1.37×) — volume total élevé incluant after-hours. La participation élevée suggère des ajustements de positions avant l'expiration vendredi.
...
**Ce qui a changé (17:00 UTC → 21:00 UTC) :**
- **Cours :** $16.175 → **$16.25** — → Stable (+0.46%)
- **Volume :** 119.0M → **162.1M** — 🔴 +36.3% (after-hours)
- **Volume relatif :** 1.03× → **1.37×** — 🔴 Participation élevée
- **RSI :** 62.29 → **62.59** — → Stable
- **ATR :** $1.02 → **$1.04** — → Stable
- **P/E Yahoo :** 101.09 → **101.56** — → Stable
- **Premium consensus :** +74.7% → **+75.5%** — → Divergence inchangée
- **SL/TP :** $14.14/$19.23 → **$14.17/$19.37** — Révisés mécaniquement
