# FLY — Mise a Jour Post-Full Refresh (2026-05-19 10:00 UTC)

> Source : `data/latest.json` (2026-05-19 10:00 UTC) + `data/recommandations_latest.json` + agents quant / geo / sector / social / FX / events / upcoming.
> **Traitement du FULL REFRESH declenche par PRICE_GAP + ATR_SPIKE (agents/detect_major_events).**

---

## Resume des changements depuis l'analyse precedente (2026-05-18 22:35 UTC)

| Metrique | 2026-05-18 22:35 UTC | 2026-05-19 10:00 UTC | Variation |
|----------|----------------------|----------------------|-----------|
| Cours close | $43.95 | **$43.95** | **0.00%** |
| RSI 14j | 67.08 | **67.08** | 0.00 |
| MM 50j | $32.72 | $32.72 | $0.00 |
| ATR 14j | $4.39 | **$4.39** | $0.00 |
| Volume jour | 9,789,240 | **9,827,800** | +0.4% |
...
**Verdict : Aucun changement materiel vs le snapshot 2026-05-18 22:35 UTC.** Le snapshot matinal du 2026-05-19 confirme la stabilite des donnees post-gap. Les triggers PRICE_GAP (+8.71%) et ATR_SPIKE (9.99%) ont deja ete integres dans l'update de 2026-05-18. Volume legerement superieur (+0.4%) — pas de signe de distribution significatif.
...
Donnees croisees Yahoo / FMP (annual FY 2025) — **inchangées vs snapshot 2026-05-18** :
...
| Max Pain | $15.00 | Yahoo Finance | Ecart de **65.9%** sous le spot. Distorsion majeure liee expiration 22/05 (3 jours) |
| Put/Call Ratio | N/A | Yahoo Finance | Donnee indisponible |
| Call OI % | N/A | Yahoo Finance | Donnee indisponible |
...
## Scoring global (Agent Recommandation — 2026-05-19 10:00 UTC)
...
|--------|--------|---------|-------------|
| Cours actuel | $43.95 | Close 2026-05-19 10:00 UTC | +8.71% vs prior close |
...
**Verdict : These CONFIRMEE — consolidation du FULL REFRESH (2026-05-19).**

Le snapshot 10:00 UTC du 2026-05-19 confirme que les donnees sont **strictement identiques** au snapshot 2026-05-18 22:35 UTC. Les triggers PRICE_GAP (+8.71%) et ATR_SPIKE (9.99%) n'ont pas genere de nouvelle information entre les deux sessions. Le cours stabilise au-dessus de $43 confirme le momentum technique, mais aucun fondamental ne justifie ce rehaussement.

**Ce qui confirme la these :**
- Donnees techniques, fondamentales et scores strictement inchanges vs snapshot 2026-05-18 22:35 UTC.
...
- Max Pain distordu a $15.00 (ecart 65.9%) — expiration options dans 3 jours (22/05).
...
- Surveiller l'expiration options du 22/05 pour normalisation de la volatilite.
