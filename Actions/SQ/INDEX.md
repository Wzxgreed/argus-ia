...
**ATTENDRE** (2026-05-20 · snapshot matinal) — Qualité opérationnelle classée **hors périmètre (3/6)** après injection FMP FY 2025-12-31 : bilan structurellement négatif (tangible asset value −$32.5B, current ratio −0.18), rentabilité GAAP inexistante (ROIC −12.8%, net margin ~0%), et dilution SBC à 5% des revenus. La valorisation reflète cette dégradation (EV/EBITDA 18.2x, P/S 1.45x) sans marge de sécurité. Le timing est bloqué par l'**earnings Q1 2026 du jour** (J=0) et l'absence de données techniques (RSI/ATR/MM). **🔴 SQ est le seul ticker de la watchlist avec un cours figé sur 5 snapshots consécutifs** (10:00 → 13:00 → 17:00 → 21:00 UTC 19/05 → 10:00 UTC 20/05 — stale price $83.46). Le cours affiché est potentiellement non représentatif du marché réel. Le secteur Technology bénéficie d'une rotation favorable (XLK top3), mais cela ne compense pas la fragilité fondamentale ni l'anomalie de données. Tout positionnement avant le call earnings et la réinjection de données fiables est déconseillé.
...
|------|---------|------|------------|
| 2026-05-20 | [SQ_2026-05-20_update.md](SQ_2026-05-20_update.md) | Mise à jour snapshot matinal | **ATTENDRE** — Qualité 3/6, earnings J=0, **stale price ≥4 jours (quality gate excluded)**, zero changement vs 19/05 21:00 UTC |
...
- **2026-05-20** · 🔴 **Earnings Q1 2026** — J=0, résultats toujours non intégrés dans le snapshot matinal 20/05
...
- Vérifier résolution du stale price dans le prochain snapshot

---

## Alertes actives

- 🔴 **Quality Gate Exclusion** — stale price ≥4 jours / 5 snapshots figés (2026-05-17 → 2026-05-20)
...
- **Geo Risk :** Non flaggué, score politique implicite faible (🟢)

---

*Dernière mise à jour : 2026-05-20 · Snapshot Matinal*
