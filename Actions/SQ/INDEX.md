...
- **2026-05-20 (initialement prévu)** · 🔴 **Earnings Q1 2026** — résultats **toujours non intégrés** dans le snapshot 27/05 (8 jours après date prévue). `upcoming_events_2026-05-27.json` affiche `"date": "2026-05-27"` avec `"days_until": 0`, mais le champ `"details": "Earnings "` est vide, et ce pattern est identique pour IREN, TEST, FUBO, AST, AXA, SPCX et QTBS (7 autres tickers), suggérant un placeholder FMP générique.
