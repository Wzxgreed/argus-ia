...
## Thèse courante
**SURVEILLER** — Valorisation de croissance extrême (P/E 153–259x, EV/Revenue 61–94x) contrebalancée par des fondamentaux solides (marges 82/32/36%, bilan quasi-sans dette, ROIC 18%). Timing technique **stable en zone neutre** : RSI 51.56 (sortie de survente confirmée et stable en close finale), sous MM50 à $142.36 (−4.0%), volumes **compressés** (−22.5% vs moyenne 20j, amélioration vs −46.9% à 17:00 UTC). Pas de position avant confirmation technique (franchissement MM50 + volume > 40M) ou compression multiple significative. XLK leader sectoriel (momentum 10.0/10) constitue un vent favorable structurel. Structure options modérément haussière (Put/Call 0.55, Call OI 64.4%). Score Opportunité 5.4/10, Score Global ajusté 46.3/100 — sous le seuil ATTENDRE (50).
...
| 2026-05-25 | [PLTR_2026-05-25_update.md](PLTR_2026-05-25_update.md) | Mise à jour snapshot 21:00 UTC (pipeline officiel) — stabilité totale vs 17:00 UTC (marché fermé Memorial Day) | SURVEILLER — Score Opp. 5.1/10, cours $136.88, RSI 35.66, volume 27.48M (−32.4%), options biais haussier renforcé (Put/Call 0.48, Call OI 67.4%), Score Global 42.5/100, thèse confirmée sans modification |
| 2026-05-26 | [PLTR_2026-05-26_update.md](PLTR_2026-05-26_update.md) | Mise à jour snapshot 13:00 UTC (pipeline officiel) — stabilité totale vs 21:00 UTC 25/05. Anomalie options JSON du snapshot 10:00 UTC résolue (Put/Call 0.55, Max Pain $140.00, Call OI 64.4% cohérents). Biais haussier options légèrement atténué vs 25/05 (Put/Call +0.07, Call OI −3.0 pp). Score Global 42.5/100 SURVEILLER confirmé | SURVEILLER — Score Opp. 5.1/10, cours $136.88, RSI 35.66, volume 27.48M (−32.4%), options réparées, thèse confirmée sans modification |
...
- **Expiration options :** 2026-05-29

## Alertes actives
- Aucune alerte seuil déclenchée
- Warning : `data/accounting_risk_latest.json` absent — Filtre Qualité non alimenté
- 🔴 **Alerte technique : RSI 35.66 < 40 — retour en zone de survente depuis le 25/05**
- 🟢 **Anomalie options JSON résolue au snapshot 13:00 UTC** — Put/Call 0.55, Max Pain $140.00, Call OI 64.4% validés et cohérents
...
- MM 50j : 142.64
- ATR 14j : 5.35
- Volume 20j moy. : 40,641,770
- Volume jour : 27,484,300
- Max Pain : 140.00 (snapshot 13:00 UTC — réparé et cohérent)
- Put/Call : 0.55 (snapshot 13:00 UTC — réparé, légère hausse vs 0.48 du 25/05)
- Call OI % : 64.4 (snapshot 13:00 UTC — réparé, repli vs 67.4% du 25/05)
