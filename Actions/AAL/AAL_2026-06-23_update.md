...
| MM 50j | **$13.16** | **$13.16** | **Inchangé** |
| Volume (session) | **177.37M** | **177.55M** | **🟢 +0.18M (+0.1%, révision mineure)** |
| Volume vs moy. 20j | **1.58×** | **1.58×** | **Inchangé** |
| Forward P/E | **7.22** | **7.22** | **Inchangé** |
...
|-----------|--------|--------|
| Cours close | $16.08 | 🟡 Session quasi-flat (+0.56%), rejet du 52W high confirmé |
| RSI 14j | 65.16 | 🟡 Zone haussière avancée — marge au surachat préservée |
...
| Volume session | 177.55M | 🔴 Volume record 1.58× moyenne = distribution ou churn institutionnel confirmé |
| 52W Range | $10.09–$16.59 | 61.0% du 52W low, **97.0% du 52W high** (rejet) |
| Support immédiat | **$15.83** | 🟢 Low du 22/06 — premier niveau de défense |
...
| Résistance | **$16.59** | 🔴 52W high — non cassé en close, rejet massif confirmé |
| Résistance secondaire | **$16.545** | 🔴 Close 17h UTC 22/06 — niveau de résistance intraday |
| Short Interest | 11.39% | 🟢 Stable — squeeze fuel intact si catalyseur |

**Interprétation technique :**
- **RSI 65.16 :** Inchangé. Distance à 70 = 4.8 pts. Marge de progression haussière limitée mais existante.
- **Volume 177.55M :** Record historique récent confirmé, **1.58× la moyenne 20j**. La révision de +0.18M vs le snapshot 21h UTC est négligeable (arrondi data). Le signal de distribution institutionnelle post-52W high reste valide.
- **High $16.59 / Close $16.08 :** Écart de $0.51 (3.1%). Rejet confirmé.
- **XLI momentum 7.54 :** Amélioration marginale vs 7.27 (snapshot précédent). Les Industriels restent #2 sector rotation avec RS20 vs SPY +6.39% (vs +6.13% précédemment) = soutien macro légèrement renforcé.
...
- **Upside implicite :** **+2.7%** vs cours $16.08.
- **Couverture :** 18 analystes — stable.

### Ratios FMP — Inchangés
| Ratio | Valeur | Signal |
|-------|--------|--------|
| Forward P/E | 7.22 | 🟡 Asymétrie atténuée (trade tactique) |
...
**Évolution fondamentale :** Aucun changement matériel. Le Forward P/E reste à **7.22**. L'upside consensus reste en **territoire positif (+2.7%)**. Le bilan reste extrêmement fragile (Filtre Qualité 0–1/6). **Aucun analyste n'a relevé son PT** = le consensus institutionnel ne valide pas le niveau.

### Événement Clé — Earnings Q2 FY2026
- **Date :** 2026-07-23 (**30 jours**, vs 31 jours précédemment)
- **Estimates EPS :** −$0.34 à $0.52 (fourchette large)
- **Estimates Revenue :** $16.6B
- **Implication :** Binary event inchangé. Fenêtre d'entrée tactique se rétrécit de 1 jour.
...
### Sector Rotation
- **XLI (Industrials) :** #2 sector ranking, momentum_score **7.54** (vs 7.27 précédemment, +0.27 pt). RS20 vs SPY **+6.39%** (vs +6.13% précédemment) — amélioration marginale.
- **Signal :** ROTATION_TO_CYCLICAL confirmée — alignement favorable pour AAL (secteur Airlines). Le momentum sectoriel s'est légèrement renforcé.
...
| Industriels (XLI) | 🟢 Favorable | Top2 sector rotation, momentum 7.54 (+0.27) |
...
| Momentum | 6.5 | **6.5** | **Inchangé** | RSI 65.16 stable. Volume record confirmé. XLI momentum +0.27 pt = soutien marginal. |
| **Score Opportunité** | **4.9** | **4.9** | **Inchangé** | Pondération agent 35/40/25. Aucun changement matériel. |

**Score Global Composite agent :** 53.8/100 (inchangé)
- Malus : geo 0, FX 0, event 0, social 0, quant 0
- Bonus : sectoriel 0 (momentum XLI amélioré mais pas au seuil de bonus)
...
| Take-Profit | $18.12 | **$18.12** | Cours $16.08 + 3×ATR $0.68 = $18.12 |
...
**Impact sur la thèse :**
- **Signal technique de distribution inchangé :** Volume record + rejet du 52W high = institutions vendant au sommet. Configuration bearish à court terme maintenue.
...
- **Si repli sous $15.83 (low du 22/06) :** Dégradation vers SURVEILLER (premier support cassé)
...
- `data/sector_rotation_latest.json` — XLI #2 ranking, momentum_score 7.54, RS20 +6.39% vs SPY
- `data/social_sentiment_latest.json` — 0 mentions, no data
- `data/validation_report.txt` — AAL OK (pas d'erreur ni warning)
- Analyse précédente : `Actions/AAL/AAL_2026-06-22_update_21h00.md` (snapshot 21h UTC)
