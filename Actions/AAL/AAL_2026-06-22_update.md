...
| ATR 14j | **$0.64** | **$0.68** | **+$0.04 (+6.3%)** |
| MM 50j | **$12.99** | **$13.07** | **+$0.08 (+0.6%)** |
| Volume (session) | **62.19M** | **126.28M** | **+64.09M (+103.1%)** |
| Volume vs moy. 20j | **0.60×** | **1.16×** | **+0.56× (expansion volumétrique)** |
| Forward P/E | **7.11** | **7.18** | **+0.07 (+1.0%)** |
| Consensus FMP PT | **$16.51 (18 analystes)** | **$16.51 (18 analystes)** | **Inchangé** |
| Upside consensus | **+4.2%** | **+3.3%** | **−0.9 pt (mécanique, cours monté)** |
| Short Interest | **11.39%** | **11.39%** | **Inchangé** |
| 52W high | **$16.50** | **$16.50** | **Inchangé — cours à 3.1% du 52W high** |
| High du jour | **$16.055** | **$16.07** | **+$0.015 — remontée des sommets** |
| Earnings Q2 (jours) | **36** | **31** | **−5 jours** |
...
|-----------|--------|--------|
| Cours close | $15.99 | 🟢 Session haussière +3.7% sur volume en expansion |
| RSI 14j | 61.34 | 🟡 Zone haussière, inchangé malgré +3.7% = pas de surachat aggravé |
| ATR 14j | $0.68 | 🟢 Légère hausse — volatilité en expansion |
| MM 50j | $13.07 | 🟢 Cours +22.4% au-dessus MM50 — tendance haussière intacte |
| MM 200j | null | 🔴 [DONNÉES MANQUANTES] |
| Volume session | 126.28M | 🟢 Volume en expansion 1.16× moyenne — accumulation potentielle |
| 52W Range | $10.09–$16.50 | 58.4% du 52W low, **96.9% du 52W high** |
| Support immédiat | **$15.77** | 🟢 Low du jour — premier niveau de défense |
| Support clé | **$15.42** | 🟢 Previous close — base de la session |
| Support secondaire | **$15.46** | 🟢 Close du 16/06 — gap partiel tenu |
| Support majeur | **$15.00** | 🟢 Gap fill + psychological |
| SL ATR | **$14.63** | 🟢 2×ATR $0.68 — référence opérationnelle |
| Résistance | **$16.07** | 🟡 High du jour > high précédent $16.055 = sommets remontés |
...
- **RSI 61.34 :** Remarquablement inchangé malgré +3.7% de hausse. Cela indique que la hausse du jour est intégrée dans une fenêtre RSI qui a fait sortir une session baissière plus ancienne. La marge avant surachat (70) reste confortable.
- **Volume 126.28M :** Expansion massive vs 62.19M du 17/06. Le gain de +3.7% sur volume 1.16× la moyenne indique un **engagement institutionnel** — probablement de l'accumulation plutôt que du retail/churn. La règle Argus-IA est claire : une progression haussière sur volume > 1.0× moyenne valide le momentum.
- **High $16.07 :** Supérieur au high précédent $16.055. La série de sommets descendants ($16.19 → $16.055) est **invalidée** — les sommets remontent, signal de **force haussière** court terme.
- **Verdict technique : FAVORABLE RENFORCÉ.** La tendance reste haussière au-dessus de la MM50, le momentum se réactive avec volume, et le cours se positionne à 3.1% du 52W high. La cassure de $16.50 nécessitera un volume > 120M pour être crédible.
...
- **Upside implicite :** +3.3% vs cours $15.99 (vs +4.2% au snapshot 17/06).
- **Couverture :** 18 analystes — stable.

### Ratios FMP — Inchangés (données LTM FY2025)
| Ratio | Valeur | Signal |
|-------|--------|--------|
| Forward P/E | 7.18 | 🟡 Asymétrie atténuée (trade tactique) |
...
**Évolution fondamentale :** Aucun changement structurel. Le Forward P/E 7.18 reste l'argument valorisation principal. Le bilan reste extrêmement fragile (Filtre Qualité 0–1/6). L'upside consensus +3.3% est désormais inférieur au seuil psychologique de +5%, ce qui pèse sur le Score Valorisation.
...
- **Implication :** Binary event se rapproche. Fenêtre d'entrée tactique se rétrécit.
...
### Sentiment Analystes
- **Inchangé :** PT moyen $16.51 (18 analystes). Upside +3.3%.

### Social Sentiment
- **Reddit / Yahoo Community :** 0 mentions (No data). Aucun pump/dump détecté.

### Sector Rotation — ✅ TOP3 (maintien)
- **Industriels (XLI)** : return_20d +6.0%, rs_20d +5.0% vs SPY, momentum_score 6.25.
- **Signal global : TOP3** (2ème secteur sur 11).
...
| Industriels (XLI) | 🟢 Favorable | TOP3 sector rotation, RS20 +5.0% vs SPY |
...
| Momentum | 6.5 | **7.0** | **🟢 +0.5** | RSI stable 61.34, volume 1.16× moyenne = progression avec conviction. Sommets remontés. |
| **Score Opportunité** | **4.9** | **5.0** | **🟢 +0.1** | Pondération 35/40/25 (régime inconnu = default). |

**Score Global Composite agent :** 55.0/100 (🟢 +1.2 pts vs 53.8)
- Malus : geo 0, FX 0, event 0, social 0, quant 0
- Bonus : sectoriel 0
- Timing : **Favorable** (inchangé)
- **Recommandation agent : ATTENDRE**
- **Recommandation institutionnelle Argus-IA : ATTENDRE — BIAIS HAUSSIER LÉGÈREMENT RENFORCÉ**
...
1. **🟢 Cours :** $15.835 → **$15.99** (+0.98% vs 17/06 close, +3.7% vs 22/06 prior close).
2. **🟢 Volume :** 62.19M → **126.28M** (+103.1%) = expansion volumétrique massive, accumulation potentielle.
3. **🟢 Volume vs moyenne :** 0.60× → **1.16×** = validation du momentum.
4. **🟢 High :** $16.055 → **$16.07** = remontée des sommets, invalidation de la fatigue.
5. **🟢 Scores :** Score Global 53.8 → **55.0** (+1.2 pts). Score Opp 4.9 → **5.0** (+0.1 pt). Momentum 6.5 → **7.0** (+0.5 pt).
...
2. 🔴 Score Valorisation 3.5/10 = faible (upside consensus +3.3% seulement).
...
- **Horizon :** — (suspendu)
- **Catalyseur clé court terme :** Cassure du 52W high $16.50 sur volume > 120M confirmé en close
...
- `data/upcoming_events_2026-06-22.json` — Earnings AAL 2026-07-23 (31 jours)
...
- `data/social_sentiment_2026-06-22.json` — 0 mentions, no data
- Analyse précédente : `Actions/AAL/AAL_2026-06-17_update_17h00.md` (snapshot 17h UTC)
