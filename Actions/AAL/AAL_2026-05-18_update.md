...
| Indicateur | Init (2026-05-17) | Update (2026-05-18) | Δ |
|-----------|-------------------|---------------------|---|
| Cours close | $12.31 | $12.31 | $0.00 (0%) |
| Change % | +2.8% (vs prev. $11.97) | -3.07% (vs prev. $12.70) | — |
| RSI 14j | 58.87 | 58.87 | 0 |
...
|-----------|--------|--------|
| Cours | $12.31 | Stable vs close précédent, mais -3.1% vs previous close $12.70 |
...
- Le volume en baisse de 28% indique une absence de pression vendeuse agressive — pullback technique dans une fourchette de consolidation.
- Le short interest à 12.21% est un niveau élevé qui crée un potentiel de short squeeze si un catalyseur positif survient (earnings, upgrade, news pétrole).
- Le put/call ratio n'est plus disponible (null) — impossible de confirmer le sentiment options extrême de l'init.

---

## Mise à Jour Fondamentale

### Consensus Analystes — NOUVEAU
- **Price Target moyen FMP : $16.02** (15 analystes, 2 mises à jour le mois dernier)
- **Upside implicite : +30.0%** vs cours $12.31
- **Couverture :** 15 analystes — coverage significatif, pas niche
- **Publishers :** TheFly, StreetInsider, Benzinga, Pulse 2.0, TipRanks Contributor

### Ratios FMP — Confirmation Bilan Stressé
...
- **Implication :** La fourchette EPS large (-$0.34 à +$0.17) reflète l'incertitude sur le fuel, la demande, et les charges. Un beat au-dessus de $0.17 serait un catalyseur majeur compte tenu du short interest 12.2%.
...
### Sentiment Analystes
- **Avant :** Coverage limité, pas de consensus FMP, "Hold" majoritaire (Yahoo 16 analystes)
...
- **Max Pain :** $5.00 — [ANOMALIE, probablement placeholder erroné]. À ignorer jusqu'à vérification.
...
| Industrials (XLI) | 🟡 Modérée | XLI RS20 -5.3% vs SPY, momentum 0/10. Pas de rotation favorable vers le secteur. |
...
| Axe | Init /10 | Update /10 | Δ | Source |
|-----|----------|------------|---|--------|
| Catalyseur | 3.5 | **6.8** | +3.3 | Consensus PT $16.02 (+30%), earnings 23/07, short interest 12.2% |
| Valorisation | 4.0 | **6.5** | +2.5 | Forward P/E 5.6 + PT $16.02 = asymétrie favorable |
...
**Verdict : MODIFIÉE — Upgrade de SURVEILLER à ACHETER (Sizing Réduit)**

### Ce qui a changé :
1. **Consensus analyste structuré** : 15 analystes, PT $16.02 (+30% upside). Cette donnée n'existait pas à l'init et justifie l'upgrade Valorisation/Catalyseur.
2. **Score Opportunité** : bond de 3.95 → 6.6/10. Le timing technique (RSI 59, au-dessus MM50) est confirmé malgré le pullback de -3.1%.
3. **Short Interest 12.2%** : niveau élevé qui crée un optionality de short squeeze si earnings Q2 surprisent à la hausse (23/07).
...
- **Si cours < $11.41 (SL) :** EXIT immédiat — trend haussier invalidé.
- **Si cours > $13.66 (TP) :** Réviser TP vers $14.00 (gap janvier) si momentum confirmé sur volume.
...
## Références
- `data/latest.json` (2026-05-18) — Cours, RSI, ATR, volume, short interest, consensus FMP
