...
## Thèse courante
**2026-06-17 (snapshot 13h UTC)** — ATTENDRE. Stabilité mécanique totale vs snapshot 10h (cours $104.63, RSI 26.80, ATR $11.55, MM50 $102.31 inchangés). [ANOMALIE OPTIONS JSON RÉSOLUE] Max Pain rétabli $115.00, Put/Call 0.58, Call OI 63.3% — skew haussier modéré révélé. Pin risk J+1 (expiration 18/06) : spot vs max pain +9.9%. Score Global 42.0/100 (ajusté 52.0/100), Score Opportunité 4.2/10. Consensus PT $90.83 (18 analysts). Filtre Qualité 3/6 inchangé. SL $81.53 / TP $139.28. Zone critique : proximité MM50 $102.31 (+2.3%). Si cassure avec volume → SURVEILLER penchant ÉVITER. Si rebond + reclaim $113–115 → maintien ATTENDRE avec nuance positive. DRAFT_refresh 13h archivé artefact duplicate.
