...
## Thèse courante
**2026-06-23 (snapshot 17h UTC)** — ÉVITER. Repli −2,77 % à $97,51 sur **EFFONDREMENT VOLUMÉTRIQUE** 0,41× (11,92 M vs moyenne 28,84 M). Thèse « distribution institutionnelle active » du snapshot 13h **invalidée** → **dérive sans acheteurs**. **CASSURE MM50 AGGRAVÉE** — spot $97,51 = −7,3 % sous MM50 $105,17 (vs −4,1 % à 13h). RSI 34,51 proche survente stricte (< 30). Score Global **31,8/100 (ÉVITER)** (+2,5 pts vs 29,3/100), Score Opportunité 4,0/10, Score Momentum **3,5/10** (+1,0 pt). Consensus PT $90,83 (18 analysts). Filtre Qualité 3/6 inchangé. SL $77,05 / TP $128,20. Zone critique : $90–$95 (support majeur) et $105,17 (résistance MM50). Si reclaim MM50 avec volume >1,0× → reconsidérer SURVEILLER. Si casse $90,00 sur volume >1,0× → risque de poursuite vers SL. Pin risk expiration 26/06 (J+3) : Max Pain $69,00 vs spot $97,51 (écart +41,3 %). Thèse ÉVITER confirmée avec nuance technique modifiée (dérive sans acheteurs vs distribution active).
