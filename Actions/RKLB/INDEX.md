...
## Thèse courante
**2026-06-23 (snapshot 13h UTC)** — ÉVITER. Stabilité mécanique totale vs snapshot 10h UTC ($100,29, RSI 36,44, ATR $10,25, volume 0,92×). **CASSURE MM50** ($104,58) inchangée — spot −4,1 % sous le support dynamique. [ANOMALIE OPTIONS JSON RÉSOLUE] — `latest.json` retourne désormais Max Pain $69,00 (cohérent), Put/Call 0,91 et Call OI 52,4 % (vs valeurs aberrantes/$null précédents). Score Global **29,3/100 (ÉVITER)**, Score Opportunité 3,7/10, Score Momentum **2,5/10** (effondrement). Consensus PT $90,83 (18 analysts). Filtre Qualité 3/6 inchangé. SL $79,79 / TP $131,04. Zone critique : $90–$95 (support majeur) et $104,58 (résistance MM50). Si reclaim MM50 avec volume >1,0× → reconsidérer SURVEILLER. Pin risk expiration 26/06 (J+3) : Max Pain $69,00 vs spot $100,29. Thèse ÉVITER confirmée avec stabilité mécanique totale et anomalie options résolue.
