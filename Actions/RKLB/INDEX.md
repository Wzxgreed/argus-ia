...
## Thèse courante
**2026-06-17 (snapshot 17h UTC)** — SURVEILLER. Rebond technique +4.24% à $109.07 sur volume effondré 0.50× (13.60M vs moy 20j 27.0M). RSI sort de survente stricte 26.80 → 30.62. MM50 remonte à $103.16 (spot +5.7%). [ANOMALIE OPTIONS JSON RÉSOLUE] Max Pain $115.00, Put/Call 0.58, Call OI 63.3% — skew haussier modéré stable. Pin risk J+1 (expiration 18/06) : spot vs max pain +5.4%. Score Global 47.0/100 (SURVEILLER), Score Opportunité 4.2/10. Consensus PT $90.83 (18 analysts). Filtre Qualité 3/6 inchangé. SL $86.27 / TP $143.27. Zone critique : $100–$103 (support MM50). Si cassure avec volume → ÉVITER. Si rebond + reclaim $113–115 → upgrade ATTENDRE. DRAFT_refresh 17h archivé faux positif ATR_SPIKE (ATR stable $11.40).
