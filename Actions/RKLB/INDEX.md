...
## Thèse courante
**2026-06-16 (snapshot 17h UTC — post-séance US)** — ATTENDRE / SURVEILLER. Repli -2.96% à $106.02 sur volume effondré 0.60×, RSI en survente 27.19 (franchissement seuil <30), ATR compressé $11.55 (-4.1%), MM50 $102.34 (marge réduite +3.6%). Score Global 43.3/100 (ajusté 53.3/100), Score Opportunité 4.3/10. Consensus PT $90.83 (18 analysts). Filtre Qualité 3/6 inchangé. SL $82.92 / TP $140.67 (ATR $11.55). [ANOMALIE OPTIONS JSON PERSISTANTE] Max Pain $65.00 aberrant — données opérationnelles 21h UTC 15/06 conservées. Zone critique : test imminent de la MM50 $102.34 / résistance $109.25 (close 13h UTC). Si cassure MM50 avec volume → ÉVITER vers $90. Si rebond sur MM50 → maintien ATTENDRE avec nuance positive.
