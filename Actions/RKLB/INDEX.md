...
## Thèse courante
**2026-06-17 (snapshot 10h UTC)** — ATTENDRE. Repli −4.23% à $104.63 sur volume normalisé 1.00×, RSI survente 26.80 confirmée (franchissement seuil <30), ATR stable $11.55, MM50 $102.31 (marge critique réduite +2.3%). Score Global 42.0/100 (ajusté 52.0/100), Score Opportunité 4.2/10. Consensus PT $90.83 (18 analysts). Filtre Qualité 3/6 inchangé. SL $81.53 / TP $139.28 (ATR $11.55). [ANOMALIE OPTIONS JSON PERSISTANTE] Max Pain $35.00 aberrant — données opérationnelles 21h UTC 15/06 conservées. Zone critique : proximité immédiate MM50 $102.31. Si cassure avec volume → SURVEILLER penchant ÉVITER vers $90. Si rebond sur MM50 avec divergence RSI → maintien ATTENDRE avec nuance positive. DRAFT_refresh 2026-06-17 validé (ATR_SPIKE 11.04%).
