...
## Thèse courante
**2026-06-09 (close officiel 21h UTC — pipeline officiel)** — SURVEILLER. Close $108.23 (−4.77% vs snapshot 13h) sur volume nettement supérieur 23.45M (0.87× moy., +75.3% vs 13h). Distribution technique confirmée : RSI 40.65, ATR $12.15 (+1.6%), MM50 $98.04 (écart réduit à +10.4%). [DRAFT_refresh 21h VALIDÉ] Trigger ATR_SPIKE 11.23% est un vrai événement technique (cours −4.77% + ATR expansion + volume hausse), vs faux positif 13h. [ANOMALIE OPTIONS JSON PERSISTANTE] Max Pain $65.00 aberrant, Put/Call 0.79 et Call OI 55.8% stables — valeurs opérationnelles conservées (Max Pain ~$130–$150). Divergence consensus réduite à +24.1% (spot vs PT $87.19) mais toujours élevée. Filtre Qualité 3/6 hors périmètre institutionnel, Forward P/E −14887, EV/Rev 94.96×, P/B 27.52×. Signal sectoriel XLI NEUTRAL amélioré (momentum 3.52/10, RS20 +0.62%). Score Global ajusté 44.5/100 (SURVEILLER, −2.5 pts vs 13h). Timing Favorable à tempérer (cours > MM50 mais écart réduit). SL $83.93 (−22.4%), TP $144.68 (+33.7%), R/R 1.5:1. [ANOMALIE DONNÉES PERSISTANTE] Market Cap Yahoo $67.62 Mds vs FMP $37.02 Mds. Zone critique à surveiller : $90–$98 (MM50 + support psychologique). Cassure sous $98.04 avec volume >1.0× = renversement de tendance.
