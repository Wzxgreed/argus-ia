...
## Thèse courante
**2026-06-29** — SURVEILLER. Repli −13,30 % en 6 séances à $84,54 ; **rebond +4,77 % aujourd'hui sur volume 1,20×** (34,33 M vs moyenne 29,64 M). Cassure supports critiques $90–$95. **CASSURE MM50 AGGRAVÉE** — spot $84,54 = **−20,1 % sous MM50 $105,80** (vs −7,3 % le 23/06). RSI 34,09 proche survente stricte. Score Global **48,3/100 (SURVEILLER)** (+16,5 pts vs 31,8), score ajusté **40,3/100**. Score Opportunité 4,8/10, Score Catalyseur 5,8/10 (+1,5 pt), Score Valorisation 4,5/10, Score Momentum 4,0/10. Consensus PT $90,83 (18 analysts). Filtre Qualité 3/6 inchangé. SL $65,80 / TP $112,65. Zone critique : $90–$95 (nouvelle résistance) et $105,80 (résistance MM50). Si reclaim $90–$95 avec volume >1,0× → reconsidérer ATTENDRE. Si casse $80,00 sur volume >1,0× → risque de poursuite vers SL. Max Pain $55,00 (écart spot +53,7 %). Thèse modifiée d'ÉVITER à SURVEILLER — rebond sur volume suggère un intérêt acheteur au niveau $80–$85, mais la tendance reste baissière.

## Historique
| Date | Fichier | Type |
|------|---------|------|
| 2026-06-29 | [RKLB_2026-06-29_update.md](RKLB_2026-06-29_update.md) | Mise à jour quotidienne — repli −13,30 % en 6 séances à $84,54, rebond +4,77 % sur volume 1,20×, cassure supports $90–$95 et MM50 aggravée (−20,1 %), upgrade scoring ÉVITER → **SURVEILLER** 48,3/100 (ajusté 40,3), Score Opportunité 4,8/10, SL/TP révisés $65,80/$112,65, Max Pain revu à la baisse $55,00, thèse modifiée d'ÉVITER à SURVEILLER avec nuance technique (distribution active vs dérive sans acheteurs)
|------|---------|------|
| 2026-06-23 | [RKLB_2026-06-23_update_17h.md](RKLB_2026-06-23_update_17h.md) | Snapshot 17h UTC — repli −2,77% à $97,51, **EFFONDREMENT VOLUMÉTRIQUE** 0,41× (11,92M vs 28,84M), thèse « distribution active » du 13h invalidée → **dérive sans acheteurs**, RSI 34,51 proche survente stricte, **CASSURE MM50 AGGRAVÉE** spot −7,3% sous MM50 $105,17, Score Global **31,8/100 ÉVITER** (+2,5 pts vs 29,3), Momentum 3,5/10 (+1,0 pt), SL/TP révisés $77,05/$128,20, thèse ÉVITER confirmée avec nuance technique modifiée |
| 2026-06-23 | [RKLB_2026-06-23_update.md](RKLB_2026-06-23_update.md) | Snapshot 13h UTC — stabilité mécanique totale vs snapshot 10h ($100,29, RSI 36,44, volume 0,92×), **CASSURE MM50** inchangée ($104,58), [ANOMALIE OPTIONS JSON RÉSOLUE] Max Pain $69,00 / Put/Call 0,91 / Call OI 52,4 % restaurés, Score Global **29,3/100 ÉVITER** stable, Momentum 2,5/10, SL/TP $79,79/$131,04, thèse ÉVITER confirmée |
| 2026-06-23 | [RKLB_2026-06-23_update.md](RKLB_2026-06-23_update.md) | Snapshot 10h UTC — stabilité mécanique totale vs close 22/06 ($100,29, RSI 36,44, volume 0,92×), **CASSURE MM50** inchangée ($104,58), [ANOMALIE OPTIONS JSON RÉCURRENTRE] max_pain $45,00 aberrant → valeurs opérationnelles $69,00/0,88/53,2% conservées, Score Global **29,3/100 ÉVITER** stable, Momentum 2,5/10, SL/TP $79,79/$131,04, thèse ÉVITER confirmée |
| 2026-06-22 | [RKLB_2026-06-22_update_21h.md](RKLB_2026-06-22_update_21h.md) | Snapshot 21h UTC — close officiel $100,29 (−6,48 % vs veille), volume révisé 27,54M (**0,92×**), RSI 36,44, cassure MM50 $104,58 confirmée (spot −4,1 %), Score Global **29,3/100 ÉVITER** stable, Momentum 2,5/10, SL/TP révisés $79,79 / $131,04, DRAFT_refresh PRICE_GAP + ATR_SPIKE **validé vrai événement**, révision volumétrique majeure invalide hypothèse « dérive sans acheteurs », thèse ÉVITER confirmée et renforcée |
...
| 2026-06-22 | [RKLB_2026-06-22_init.md](RKLB_2026-06-22_init.md) | Full Refresh complété — trigger PRICE_GAP −6,48 % + ATR_SPIKE 10,22 % validé vrai événement technique, thèse ÉVITER confirmée et renforcée par révision volumétrique 0,92× |
...
| 2026-06-09 | [RKLB_2026-06-09_update.md](RKLB_2026-06-09_update.md) | Snapshot matin 10h UTC — stabilité totale vs close 21h 08/06, [ANOMALIE OPTIONS JSON RÉCURRENTRE], score global ajusté 47,0/100 (SURVEILLER, inchangé), thèse confirmée |
...
| 2026-05-20 | [RKLB_2026-05-20_update.md](RKLB_2026-05-20_update.md) | Snapshot 13h UTC — anomalie options résolue, thèse ÉVITER confirmée |
