...
NU est le leader néo-banque latino-américain (Brésil/Mexique/Colombie) avec 100M+ clients, des marges opérationnelles solides (24.4%), un bilan net cash (net debt/EBITDA −2.47×), et une valorisation forward attractive (P/E ~11×, upside consensus +41.6%). Le snapshot 21:00 UTC du 01/06 enregistre la close officielle à **$12.99** (−1.07% vs previous close $13.13), en consolidation après la session US. La configuration technique reste **constructive malgré un léger repli** : le RSI corrige à **42.65** (−1.07 pt vs 17h, mais +9.24 pts vs 27/05), restant dans la zone de neutralité relative. Le volume de session se normalise à 46.89M (0.82× moyenne 20j), corrigeant l'interprétation post-session de 17h (0.32×) qui reflétait un marché illiquide after-hours. La **rotation sectorielle cyclique** (`ROTATION_TO_CYCLICAL`) se **maintient** avec XLF (Financials) dans le **top3 sectoriel** — un vent de queue contextuel stable pour NU. L'anomalie options reste résolue (max pain $13.00 cohérent, put/call 0.91, call OI 52.4%). Le score global ajusté reste à **55.5** (=), dans la zone **ATTENDRE** (50–59). Les fondamentaux restent intacts (ROIC 16.3%, consensus $18.39, 10 analysts). Aucune news structurante. Le momentum (3.5/10) reste faible et le timing défavorable (sous MM50 $14.01, distance −7.3%). Attente d'un franchissement de la MM50 ou d'un RSI > 50 avant tout nouvel achat.
