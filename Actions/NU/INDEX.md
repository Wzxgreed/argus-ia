...
- **Expiration Options :** 2026-06-12 (4 jours, max pain $13.00 — cohérent avec le spot)

## 📝 Résumé de la Thèse

NU est le leader néo-banque latino-américain (Brésil/Mexique/Colombie) avec 100M+ clients, des marges opérationnelles solides (24.4%), un bilan net cash (net debt/EBITDA −2.47×), et une valorisation forward attractive (P/E ~10.1×, upside consensus +50.8%). Le close officiel 21:00 UTC du 08/06 confirme la thèse **ATTENDRE** avec une **nuance majeure** : le volume final est révisé à la hausse massive de 0.39× à **0.80×**, révélant une **distribution vendeuse réelle** et non un marché illiquide. Le cours est quasi-stable vs 17h à $11.60 (−3.09% vs previous close), le RSI reste à **41.77**, et le momentum baisse de 3.5 à **3.0/10**. Le score global ajusté passe de 55.5 à **54.2** (−1.3 pt), restant dans la zone ATTENDRE. L'anomalie options JSON reste résolue (max pain $12.00, put/call 1.02, call OI 49.4%). Le signal sectoriel reste **`NEUTRAL`** avec XLF top3 momentum 4.0. Les fondamentaux restent intacts (ROIC 16.3%, consensus $17.49, forward P/E 10.13×). Le support critique $11.20 (52W low) est désormais à seulement +3.4%. Aucune news structurante sur NU. La recommandation **ATTENDRE** est confirmée avec vigilance accrue. SL **$10.52** / TP **$13.22**.
