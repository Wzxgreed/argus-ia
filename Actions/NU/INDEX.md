...
|---------|------|------|---------|
| [NU_2026-06-02_update.md](NU_2026-06-02_update.md) | 2026-06-02 | Update quotidienne (snapshot 10:00 UTC) | ATTENDRE — thèse confirmée, **stabilité totale** vs 01/06 (cours $12.99 inchangé, RSI 42.65, ATR $0.46, volume 59.52M/1.03×), **rotation cyclique maintenue** (`ROTATION_TO_CYCLICAL`, XLF top3), 🔴 anomalie data quality options (max pain $5.00 vs historique $13.00, put/call null, call OI null), scores inchangés (Global 63.5, Ajusté 55.5, Opportunité 6.3, Momentum 3.5), SL $12.07 / TP $14.37 |
...
- **Expiration Options :** 2026-06-05 (4 jours, max pain $13.00 — cohérent avec le spot)

## 📝 Résumé de la Thèse

NU est le leader néo-banque latino-américain (Brésil/Mexique/Colombie) avec 100M+ clients, des marges opérationnelles solides (24.4%), un bilan net cash (net debt/EBITDA −2.47×), et une valorisation forward attractive (P/E ~11×, upside consensus +41.6%). Le snapshot 10:00 UTC du 02/06 enregistre **$12.99** (−1.07% vs previous close $13.13), en **stabilité totale** vs la close du 01/06. La configuration technique est **quasi-identique** : RSI **42.65** inchangé, ATR **$0.46** inchangé. Le volume se normalise davantage à **59.52M (1.03× moyenne 20j)**, confirmant une participation de session standard et légèrement supérieure à la moyenne. La **rotation sectorielle cyclique** (`ROTATION_TO_CYCLICAL`) se **maintient** avec XLF (Financials) dans le **top3** — vent de queue contextuel stable. 🔴 **Anomalie data quality options** détectée (max pain $5.00 vs historique $13.00, put/call null, call OI null) — pattern systémique du jour, données historiques à utiliser. Le score global ajusté reste à **55.5** (=), dans la zone **ATTENDRE** (50–59). Les fondamentaux restent intacts (ROIC 16.3%, consensus $18.39, 10 analysts). Aucune news structurante. Le momentum (3.5/10) reste faible et le timing défavorable (sous MM50 $14.01, distance −7.3%). Attente d'un franchissement de la MM50 ou d'un RSI > 50 avant tout nouvel achat.
