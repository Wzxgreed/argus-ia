...
IREN est en plein pivot stratégique : du **Bitcoin mining pur** vers l'**infrastructure HPC/IA** de référence. Le contrat **$3.4B avec NVIDIA** reste le catalyseur structurant. Le snapshot 17:00 UTC du 2026-06-02 enregistre un **breakout haussier** avec cours à **$67.30 (+3.02%)** et un **nouveau high historique intraday à $69.57**, dépassant pour la première fois le **consensus analystes $66.61**. Cependant, ce mouvement s'opère sur un **volume réduit à 29.68 M (50.7% de la moyenne 20j)**, signalant un manque de conviction institutionnelle. Le cours évolue **+38.0% au-dessus de la MM50** ($48.76), tendance haussière intacte.

**🔴 Valorisation stretched :** P/E TTM **87.40×**, EV/EBITDA **170.54×**, Forward P/E **−71.60×** (détérioration sévère persistante), P/B **8.89×**. Le **Score Valorisation reste à 3.0/10**.

**🟡 Consensus PT dépassé :** Le cours **$67.30 dépasse désormais le consensus FMP** ($66.61, 23 analysts). L'upside vers le consensus est devenu **négatif (−1.0%)**.

**🟡 Structure options stable :** Put/Call ratio **2.09** (puts 67.6%), Call OI **32.4%**, Max Pain **$52.00** (expiration 2026-06-05). La défiance du marché options persiste malgré le nouveau high.

**🔴 Volume faible :** 29.68 M = **50.7%** de la moyenne 20j. Le breakout se fait sans participation institutionnelle confirmée, fragilisant le signal.
...
**Action : ATTENDRE** — risque/rendement défavorable à l'entrée (breakout non confirmé par le volume, valuation extrême)

> **⚠️ Réserve earnings :** Les résultats Q1 2026 ne sont toujours pas intégrés dans les feeds (FY 2025 uniquement). Attendre la publication officielle avant toute nouvelle entrée. Ne pas entrer à $67.30 (Forward P/E −71.6×, EV/EBITDA 170×, put/call 2.09). Si le cours casse $64.27 sans rebond → signe de faiblesse. Si le cours casse $60.26 sans rebond → passer en SURVEILLER. Si le cours casse $56.83 sans rebond → passer en ÉVITER. Si le cours casse $48.76 (MM50) → passer en ÉVITER. Surveiller la clôture au-dessus de $66.61 avec volume confirmé.
