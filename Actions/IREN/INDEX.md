...
**🟡 Structure options améliorée :** Put/Call ratio **2.09** (vs 3.01 au close 01/06, −30.6%), Call OI **32.4%** (vs 24.9% au close 01/06, +7.5 pts), Max Pain **$52.00** (expiration 2026-06-05) — anomalie $20.00 du snapshot 10h corrigée. La défiance record du marché options s'atténue, même si la structure reste défensive (puts 67.6%).
...
> **⚠️ Réserve earnings :** Les résultats Q1 2026 ne sont toujours pas intégrés dans les feeds (FY 2025 uniquement). Attendre la publication officielle avant toute nouvelle entrée. Ne pas entrer à $65.33 (Forward P/E −70×, EV/EBITDA 170×, put/call 2.09). Si le cours casse $60.26 sans rebond → passer en SURVEILLER. Si le cours casse $56.83 sans rebond → passer en ÉVITER. Si le cours casse $48.24 (MM50) → passer en ÉVITER. Surveiller le dépassement de $66.61 (consensus PT) avec volume confirmé.
