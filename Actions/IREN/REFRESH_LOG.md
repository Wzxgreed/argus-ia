...
## 2026-06-23 — Full Refresh Complété (snapshot 13:00 UTC)

**Triggers :**
- price_gap (medium) : Gap -5.15% overnight (seuil ±5.0%) — **faux positif hérité**
- atr_spike (medium) : ATR relatif 9.95% (seuil 5.0%) — **faux positif hérité**

**Conclusion :** confirm — faux positif (triggers hérités du close 2026-06-22, données brutes strictement identiques, anomalie options résolue)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 10.27% (seuil 5.0%)
...
- atr_spike (medium) : ATR relatif 11.14% (seuil 5.0%)
...
- atr_spike (medium) : ATR relatif 11.13% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 11.43% (seuil 5.0%)
...
- atr_spike (medium) : ATR relatif 11.64% (seuil 5.0%)
...
- atr_spike (medium) : ATR relatif 11.63% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 10.61% (seuil 5.0%)
