...
## Thèse courante
La thèse sur ASTS est **modifiée : ATTENDRE → SURVEILLER** — snapshot 10h UTC 2026-06-10 avec données techniques partielles. **Downgrade mécanique** de −10 pts (Score global 48,5/100) sur close NaN, ATR14 null et MM50 null. RSI **51,78** (neutre, +1,51 pt), volume **normalisé 1,01×** stable. Divergence consensus mécanique réduite ($92,06 previous_close vs PT $94,54 = **+2,69% upside** ; upside réel +6,59% si spot $88,71). Profil fondamental spéculatif extrême inchangé (EV/Revenue 318×, P/B 12,73×, Forward P/E −432,31, non rentable). Signal sectoriel **UNKNOWN** (données partielles). Timing **Indéterminable** (données techniques incomplètes). Options **anomalie JSON récurrente** : max pain **$45 aberrant** (valeur opérationnelle $120 conservée), put/call et call OI null. Verdict global : **ne pas entrer long sans close fiable au-dessus de $92 sur volume >0,8×**. Risque de rupture sous MM50 ($88,70 non confirmé) = objectif $80–$85. Volatilité extrême persistante (dernier ATR connu 15,0% du cours).
