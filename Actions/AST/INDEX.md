...
- Aucune donnée de cours disponible dans les snapshots (`No price history`) — confirmé stable sur 4 snapshots consécutifs (18/05 21:23, 22:36, 23:09 UTC ; 19/05 10:00 UTC)
...
|------|---------|------|--------|
| 2026-05-19 | `AST_2026-05-19_update.md` | Update (10:00 UTC) | Données manquantes confirmées — aucun changement vs 18/05, AST absent du quality gate, doublon ASTS confirmé |
