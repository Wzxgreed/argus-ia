...
- Aucune donnée de cours disponible dans les snapshots (`No price history`) — confirmé stable sur 8 snapshots consécutifs (18/05 21:23, 22:36, 23:09 UTC ; 19/05 10:00, 13:00, 17:00, 21:00 UTC ; 20/05 10:00 UTC)
- Aucune analyse initiale (`_init.md`) n'a été produite
- Earnings programmés le 2026-05-20 (source FMP) mais résultats non intégrés au pipeline
...
|-----------|------|--------|
| Earnings | 2026-05-20 | Programmé (FMP) — résultats non disponibles dans les snapshots |
...
- Pas de données FMP, pas de données Yahoo Finance dans les snapshots du 18/05, 19/05 et 20/05
