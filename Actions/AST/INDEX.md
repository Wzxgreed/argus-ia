...
**Statut :** DONNÉES MANQUANTES PERSISTANTES — analyse initiale requise / anomalie structurelle confirmée (23 snapshots) / stabilisation proxy ASTS à $105.65

- Aucune donnée de cours disponible dans les snapshots (`No price history`) — confirmé stable sur **>23 snapshots consécutifs** (18/05 → 01/06)
- Aucune analyse initiale (`_init.md`) n'a été produite
- Earnings programmés le 2026-06-01 (source FMP) — placeholder glissant J=0 non résolu depuis le 26/05 (7 jours de glissement), résultats non disponibles dans les snapshots
- Scoring agent AST : placeholder 55.2/100 — action ATTENDRE par défaut
- AST absent du quality gate (alors qu'ASTS y figure)
- **Anomalie structurelle confirmée :** doublon probable avec ASTS (AST SpaceMobile), ticker correct et liquide sur NASDAQ. ASTS a stabilisé à **$105.65** au snapshot 21:00 UTC (rebond +2.82% vs close 17h, −6.84% vs close veille) après correction intra-day jusqu'à **$101.21**. Volume total de séance revenu à la moyenne 20j (**27.07M, 1.00×**), RSI **61.89** (neutre-haussier), short interest **17.60%** stable, consensus **$94.54** (12 analysts) inchangé, premium consensus **+11.8%**. L'agent maintient ASTS en **SURVEILLER (44.8/100)**. Signal sectoriel **ROTATION_TO_CYCLICAL** stable (XLK top1, momentum 10.0) — paradoxe persistant : ASTS sous-performe son secteur leader. Supports/résistances ASTS : support immédiat **$101.21**, résistance **$105–110** (ancien support cassé), max pain options **$120**.
