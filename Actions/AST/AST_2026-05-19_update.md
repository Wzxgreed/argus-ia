# AST — Mise à jour 2026-05-19 (snapshot 10:00 UTC)

> **Date :** 2026-05-19
> **Type :** Update post-pipeline 10:00 UTC
> **Statut données :** [DONNÉES MANQUANTES] — aucun historique de prix disponible
> **Source :** data/2026-05-19.json, data/recommandations_2026-05-19.json, data/upcoming_events_2026-05-19.json, data/geo_2026-05-19.json, data/social_sentiment_2026-05-19.json, data/fx_exposure_2026-05-19.json, data/quality_gate_2026-05-19.json

---

## 1. Résumé des changements depuis l'analyse précédente

**Analyse précédente :** `AST_2026-05-18_update.md` (snapshot 23:09 UTC)

| Élément | Snapshot 23:09 UTC (18/05) | Snapshot 10:00 UTC (19/05) | Changement |
|---------|---------------------------|---------------------------|------------|
...
| Earnings J=0 | Programmé (18/05, FMP) | Programmé (19/05, FMP) | Date glissante — résultats non reçus |
| Quality Gate | Non listé | Non listé | Confirmé |

**Constat :** Le snapshot 10:00 UTC du 2026-05-19 confirme la **stabilité totale de l'absence de données** pour AST. Aucun cours, volume, RSI, ATR, ni donnée FMP n'est disponible. L'événement earnings programmé à J=0 (source FMP) n'a pas alimenté de résultats exploitables dans le pipeline. AST n'est pas non plus référencé dans le `quality_gate_2026-05-19.json` (contrairement à ASTS, statut `ok`).

---

## 2. Mise à jour technique

| Métrique | Valeur précédente | Valeur actuelle (10:00 UTC) | Variation |
|----------|-------------------|----------------------------|-----------|
...
Aucune donnée fondamentale (P/E, EV/EBITDA, FCF, margins, consensus) n'est présente dans `data/2026-05-19.json` pour AST. Le Filtre Qualité 6 critères ne peut pas être calculé.

---

## 4. Mise à jour sentiment / options / news

- **Sentiment retail :** 0 mentions Reddit, score 0/10 — `social_sentiment_2026-05-19.json`
- **News :** aucune news détectée pour AST dans `data/news_2026-05-19.json`
- **Options / Unusual activity :** [DONNÉES MANQUANTES] — pas de données de marché
- **Upgrades/downgrades :** [DONNÉES MANQUANTES]
- **Événements :** Earnings programmé le 2026-05-19 (FMP, `days_until: 0`) mais résultats non intégrés (`upcoming_events_2026-05-19.json`)
- **Geo / FX :** score géo 2/10 (🟢), exposition FX 25% (🟢), impact neutre — pas de signal

---

## 5. Scoring global (données agents)

> ⚠️ Les scores ci-dessous sont issus de `data/recommandations_2026-05-19.json` et comportent des valeurs placeholders en l'absence de données réelles.
...
- `ASTS` (AST SpaceMobile) — données complètes : cours $86.83, RSI 60.85, ATR 7.39, MM50 83.66, volume 23.9M, score opportunité 5.5/10 dans `recommandations_2026-05-19.json`, statut `ok` dans le quality gate
...
**Verdict : NON ÉVALUABLE / DONNÉES MANQUANTES — CONFIRMÉ AU SNAPSHOT 10:00 UTC (19/05)**

- Aucune analyse initiale n'a été produite pour AST (pas de `_init.md`)
- Le snapshot technique du jour reste vide (`No price history`) après quatre snapshots consécutifs (21:23, 22:36, 23:09 UTC le 18/05 ; 10:00 UTC le 19/05)
...
- **Aucun changement significatif** détecté entre les snapshots du 18/05 et du 19/05
- AST n'est pas référencé dans le `quality_gate_2026-05-19.json` (alors que ASTS l'est, statut `ok`)
