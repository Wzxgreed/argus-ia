...
**Triggers :**
- price_gap (medium) : Gap -9.02% overnight (seuil ±5.0%)
- atr_spike (medium) : ATR relatif 5.43% (seuil 5.0%)

**Conclusion :** [Obsolète — remplacé par le second trigger du même jour]
...
**Conclusion :** Thèse CONFIRMÉE — correction en cours tel qu'anticipée par l'alerte options (put/call 3.08). Le cours a chuté de $370.94 à $336.47 (−9.29%), touchant un low intraday à $333.88 proche de la zone d'entrée suggérée ($330–$340). La thèse fondamentale (Quality Compounder 5–6/6, ROIC 18.5%, moat IA) reste intacte. La valorisation s'améliore mécaniquement (P/E 84.7 vs 93.4) mais reste extrême. Le timing passe de "Attendre" à "Surveiller activement" la zone $330–$333. Recommandation : SURVEILLER (Score Global 43.8/100). Voir [VRT_2026-05-18_update.md](./VRT_2026-05-18_update.md).
...
## 2026-05-18 — Full Refresh Triggered (archive)

**Triggers :**
- price_gap (medium) : Gap -8.24% overnight (seuil ±5.0%)
- atr_spike (medium) : ATR relatif 5.49% (seuil 5.0%)

**Conclusion :** Résolu — fusionné avec le refresh suivant (même gap, données affinées). DRAFT archivé.
...
## 2026-05-18 — Full Refresh Triggered (final)
...
**Triggers :**
- price_gap (medium) : Gap -5.14% overnight (seuil ±5.0%)
...
**Triggers :**
- price_gap (medium) : Gap -5.09% overnight (seuil ±5.0%)
...
**Triggers :**
- price_gap (medium) : Gap -5.03% overnight (seuil ±5.0%)
- atr_spike (medium) : ATR relatif 6.13% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 5.83% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 5.95% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 6.32% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 5.75% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 5.63% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 5.47% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 5.45% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 5.54% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 6.01% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 5.96% (seuil 5.0%)
...
**Triggers :**
- price_gap (medium) : Gap -7.07% overnight (seuil ±5.0%)
...
**Triggers :**
- price_gap (medium) : Gap +6.01% overnight (seuil ±5.0%)
- atr_spike (medium) : ATR relatif 6.22% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 6.24% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 6.09% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 6.10% (seuil 5.0%)
...
**Triggers :**
- price_gap (medium) : Gap +6.33% overnight (seuil ±5.0%)
...
**Triggers :**
- price_gap (medium) : Gap +5.22% overnight (seuil ±5.0%)
- atr_spike (medium) : ATR relatif 6.02% (seuil 5.0%)
...
**Triggers :**
- price_gap (medium) : Gap -9.68% overnight (seuil ±5.0%)
...
**Triggers :**
- price_gap (medium) : Gap -9.14% overnight (seuil ±5.0%)
...
**Triggers :**
- price_gap (high) : Gap -11.03% overnight (seuil ±5.0%)
- atr_spike (medium) : ATR relatif 6.98% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 6.86% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 7.00% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 7.01% (seuil 5.0%)
...
**Triggers :**
- atr_spike (medium) : ATR relatif 6.72% (seuil 5.0%)
...
- atr_spike (medium) : ATR relatif 7.11% (seuil 5.0%)
...
- atr_spike (medium) : ATR relatif 7.13% (seuil 5.0%)
...
**Triggers :**
- price_gap (medium) : Gap -6.64% overnight (seuil ±5.0%)
- volume_surge (medium) : Volume 3.0× moyenne 20j (21,974,500 vs 7,214,525)
- atr_spike (medium) : ATR relatif 7.14% (seuil 5.0%)
