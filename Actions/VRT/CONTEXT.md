...
- Anomalie options — RÉSOLUE (put/call 2.23 / max pain $215 / call OI 31%) — 🟢
...
- **Date :** 2026-05-20
- **Type :** update (révision post-anomalie)
- **Fichier :** `VRT_2026-05-20_update.md`
- **Conclusion :** Anomalie options résolue (put/call 0.0 → 2.23, max pain $190 → $215). Open/high du 19/05 révèlent pattern de distribution (gap down $329.68, rebond échoué $334.62). Thèse CONFIRMÉE — SURVEILLER (Score Global 45.0/100).
