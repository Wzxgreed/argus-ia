...
**Prochain Earnings :** 2026-07-29 (56 jours · Est EPS $1.38–$1.59 / Rev ~$3.4B)
...
| Open | **$335.15** | Identique clôture 02/06 |
| High | **$345.18** | Identique clôture 02/06 |
| Low | **$331.23** | Identique clôture 02/06 |
| Support clé | **$310.02** (MM50) | Support structurel. Si rupture → correction vers $295–$300 (−11.8% à −14.2%) |
| Support immédiat | **$331.23** (low 02/06) | Zone de rejet intraday à surveiller en ouverture US |
...
| Résistance intermédiaire | **$345.18** (high 02/06) | Rejet intraday confirmé. Première résistance à breaker |
...
| EV/EBITDA (Yahoo TTM) | Yahoo | **54.24** | Premium massif. Stable |
| EV/Revenue | Yahoo | **11.92** | Stable |
...
> [WARNING JSON Schema] — `fmp_key_metrics.market_cap` type float au lieu de integer (non bloquant, même warning qu'aux snapshots précédents).
...
| Upcoming Events | Earnings 2026-07-29 (56j) | 🟡 Prochain catalyseur binaire dans 56 jours |
| Quality Gate | VRT status = `ok` | 🟢 Aucune exclusion ni warning pour VRT |
| Validation Report | 1 ERROR non bloquant (JSON schema VRT) | 🟡 Même warning qu'hier — non bloquant |
...
- **Niveaux techniques :** 🟢 **Stable** — Support $324 confirmé et pivoté. Low $331.23 > ancien support $324. Résistance immédiate $345.18 (high du 02/06 rejeté).
...
- 🟡 **Résistance $345.18** — High du 02/06 rejeté. À breaker pour confirmer le rebond
