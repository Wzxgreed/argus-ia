...
> **Dernière mise à jour :** 2026-05-26 (snapshot 21h00 UTC)
> **Statut :** 🔴 DONNÉES MANQUANTES — ticker à corriger (`CS.PA` ou `AXAHY`) + dégradation sectorielle marginale XLF entre 17h00 et 21h00 (RS 20j −4.74% → −4.88%, RS 60j −8.24% → −8.38%), marché close sans résolution du sourcing
...
- **[INFO]** Dégradation sectorielle marginale XLF entre 17h00 et 21h00 : RS 20j dégradé (−4.74% → −4.88%), RS 60j dégradé (−8.24% → −8.38%), return 20j légèrement amélioré (0.00% → +0.08%), return 60j légèrement amélioré (+1.26% → +1.33%), momentum 0.0/10
