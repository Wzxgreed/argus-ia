...
> **Statut :** 🟡 DONNÉES MANQUANTES — ticker à corriger (`CS.PA` ou `AXAHY`) + earnings J0 FMP glissant sans détails (30e jour consécutif). **SCORING STABLE** : Score Opportunité 5.5/10, Score Global 55.2/100, Recommandation ATTENDRE. **MUTATION SECTORIELLE XLF POSITIVE NETTE** : momentum 8.40/10 (+2.17 pt vs 23/06), RS 20j +8.00% (+3.04 pp), RS 60j −3.50% (+0.86 pp), return 20j +4.85% (+0.75 pp), return 60j +8.89%. Rang 4e/11 (vs 3e/11) — descente mécanique, pas organique. Signal macro `UNKNOWN` stable. Vent arrière théorique **fortement renforcé** pour un assureur.
...
| `AXA_2026-05-26_update.md` | 2026-05-26 | Mise à jour quotidienne (snapshot 10h00 UTC) | Données manquantes persistantes — 12e snapshot consécutif sans mutation ; earnings J0 FMP (2026-05-26) sans détails exploitables ; headwind sectoriel XLF stable (RS 20j −6.51%, return 20j −2.29%, momentum 0.0/10) ; marché rouvert post-Memorial Day sans résolution du sourcing |
| `AXA_2026-05-26_update.md` | 2026-05-26 | Mise à jour quotidienne (snapshot 13h00 UTC) | Données manquantes persistantes — 13e snapshot consécutif sans mutation ; earnings J0 FMP (2026-05-26) sans détails exploitables ; stabilité totale sectorielle XLF (RS 20j −6.51%, return 20j −2.29%, momentum 0.0/10) ; marché actif et liquide sans résolution du sourcing |
| `AXA_2026-05-26_update.md` | 2026-05-26 | Mise à jour quotidienne (snapshot 17h00 UTC) | Données manquantes persistantes — 14e snapshot consécutif sans mutation ; earnings J0 FMP (2026-05-26) sans détails exploitables ; mutation sectorielle XLF détectée entre 13h00 et 17h00 (RS 20j −6.51% → −4.74%, return 20j −2.29% → 0.00%, return 60j −0.56% → +1.26%) ; marché actif et liquide sans résolution du sourcing |
...
| `AXA_2026-06-23_update.md` | 2026-06-23 | Mise à jour quotidienne (snapshot 10h00 UTC) | Données manquantes persistantes (4 tickers KO sur 29) — 25e snapshot consécutif ; fichier sectoriel exploitable — XLF rang 3e/11 (stable), momentum 5.45/10 (vs 5.08/10), RS 20j +3.69% (vs +3.33%), RS 60j −4.41% (vs −4.79%), return 20j +4.17% (vs +3.81%) ; **amélioration organique sectorielle** confirmée sur les 4 métriques ; signal macro `UNKNOWN` stable ; earnings J0 FMP (2026-06-23) sans détails exploitables — 28e jour consécutif |
| `AXA_2026-06-23_update_13h.md` | 2026-06-23 | Mise à jour quotidienne (snapshot 13h00 UTC) | **Stabilité totale inter-snapshot** — données manquantes persistantes (4 tickers KO sur 29) — 26e snapshot consécutif ; fichier sectoriel strictement inchangé (XLF rang 3e/11, momentum 5.45/10, RS 20j +3.69%, RS 60j −4.41%, return 20j +4.17%) ; signal macro `UNKNOWN` stable ; earnings J0 FMP (2026-06-23) sans détails exploitables — 28e jour consécutif ; aucune mutation détectée entre 10h et 13h |
| `AXA_2026-06-29_update.md` | 2026-06-29 | Mise à jour quotidienne (snapshot 10h00 UTC) | Données manquantes persistantes (4 tickers KO sur 29) — 30e snapshot consécutif ; **mutation sectorielle XLF positive nette** (momentum 8.40/10 vs 6.23/10, RS 20j +8.00% vs +4.96%, RS 60j −3.50% vs −4.36%, return 20j +4.85% vs +4.10%, return 60j +8.89%) ; rang 4e/11 (vs 3e/11) mécanique ; signal macro `UNKNOWN` stable ; earnings J0 FMP (2026-06-29) sans détails exploitables — 30e jour consécutif ; scoring stable ATTENDRE 55.2/100 |
| `AXA_2026-06-23_update_17h.md` | 2026-06-23 | Mise à jour quotidienne (snapshot 17h00 UTC) | Données manquantes persistantes (4 tickers KO sur 29) — 27e snapshot consécutif ; **mutation sectorielle XLF positive** détectée entre 13h et 17h (momentum 5.45 → 6.23, RS 20j +3.69% → +4.96%, RS 60j −4.41% → −4.36%, return 20j +4.17% → +4.10%) ; amélioration organique nette sur momentum et RS 20j ; rang 3e/11 conservé ; signal macro `UNKNOWN` stable ; earnings J0 FMP (2026-06-23) sans détails exploitables — 29e jour consécutif |
...
| 2026-06-22 (10h00) | 5.5/10 (C:6.5 V:5.0 M:5.0) | 55.2/100 | ATTENDRE | Neutre |
| 2026-06-23 (10h00) | 5.5/10 (C:6.5 V:5.0 M:5.0) | 55.2/100 | ATTENDRE | Neutre |
| 2026-06-23 (13h00) | 5.5/10 (C:6.5 V:5.0 M:5.0) | 55.2/100 | ATTENDRE | Neutre |
| 2026-06-29 (10h00) | 5.5/10 (C:6.5 V:5.0 M:5.0) | 55.2/100 | ATTENDRE | Neutre |
...
|-----------|------|--------|
| Earnings | 2026-06-23 | **J0 FMP — sans détails exploitables (données manquantes)** |
...
- **[WARNING]** Earnings J0 (2026-06-23) sans consensus ni résultats exploitables — pattern persistant depuis mi-mai (29e occurrence consécutive)
- **[INFO]** **Fichier sectoriel exploitable** : `data/sector_rotation_2026-06-23.json` valide — XLF rang 3e/11 (stable), momentum 6.23/10 (+0.78 pt vs 13h), RS 20j +4.96% (+1.27 pp vs 13h), RS 60j −4.36% (+0.05 pp vs 13h), return 20j +4.10% (−0.07 pp vs 13h). **Mutation positive nette** détectée entre 13h et 17h, portée par le momentum et le RS 20j. Vent arrière théorique **renforcé** pour un assureur. Signal macro `UNKNOWN` stable
