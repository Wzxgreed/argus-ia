...
> **Dernière mise à jour :** 2026-06-01 (snapshot 17h00 UTC)
> **Statut :** 🔴 DONNÉES MANQUANTES — ticker à corriger (`CS.PA` ou `AXAHY`) + earnings J0 FMP glissant sans détails (7e jour consécutif)
...
- **[INFO]** Headwind sectoriel XLF persistant : RS 20j −6.28%, RS 60j −10.81%, return 20j −1.13%, return 60j +0.72%, momentum 0.0/10 ; signal macro basculé à `ROTATION_TO_CYCLICAL` à 17h00 UTC
