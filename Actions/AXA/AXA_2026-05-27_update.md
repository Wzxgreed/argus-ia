...
> **Date :** 2026-05-27
> **Snapshot :** 2026-05-27T10:00:01 UTC
> **Type :** `_update.md` (post-pipeline matin)
> **Analyste :** Desk Argus-IA
> **Réf. précédent :** `AXA_2026-05-26_update.md` (snapshot 21h00 UTC)

---

## Résumé des changements depuis l'analyse précédente

| Élément | État 2026-05-26 21h00 | État 2026-05-27 10h00 | Changement |
|---------|----------------------|----------------------|------------|
...
| Earnings FMP | J0 (2026-05-26) | **J0 (2026-05-27)** | Date calendrier glissante, toujours sans détails |

**Verdict :** 16e snapshot consécutif sans mutation des données AXA. Le symbole "AXA" reste non reconnu par yfinance (instrument non coté US). Le contexte sectoriel XLF est strictement inchangé vs le snapshot 21h00 UTC du 26/05 : RS 20j −4.88%, RS 60j −8.38%, return 20j +0.08%, return 60j +1.33%, momentum 0.0/10. La session US pré-market (10h00 UTC) n'a pas permis la récupération de données pour AXA. L'absence totale de mutation confirme le caractère structurel du problème de symbole.

---

## Mise à jour technique

**[DONNÉES MANQUANTES]** Aucun cours, volume, RSI, ATR ou moyenne mobile disponible pour AXA dans `data/latest.json` (snapshot 2026-05-27T10:00:01 UTC).

**Contexte sectoriel (XLF) — stabilité totale vs close 26/05 :**
...
**Interprétation :** Le secteur financier maintient sa sous-performance relative vs le S&P 500 à des niveaux identiques à ceux observés hier soir. Aucune mutation technique sectorielle n'est survenue entre la close US du 26/05 et le snapshot pre-market du 27/05. La Tech (XLK return 20j +15.3%, momentum 10.0/10) continue de capter les flux au détriment des Financials. Sans données AXA, on ne peut évaluer si le titre sur/sous-performe son secteur.
...
| **Évolution** | **Non évaluable** (données de prix absentes + stabilité totale sectorielle XLF vs close 26/05) |
...
2. **Stabilité sectorielle totale :** Entre la close US du 26/05 (21h00 UTC) et le snapshot pre-market du 27/05 (10h00 UTC), les métriques XLF sont strictement identiques : RS 20j −4.88%, RS 60j −8.38%, return 20j +0.08%, return 60j +1.33%, momentum 0.0/10. Aucune mutation technique sectorielle n'est survenue.
3. **Earnings J0 non résolu :** L'événement earnings du 2026-05-27 est répertorié dans le calendrier FMP mais sans données de consensus ni résultats. L'impact sur le cours ne peut être mesuré. C'est le 3e jour consécutif où le calendrier FMP glisse la date J0 sans fournir de détails exploitables.
4. **Marché stable :** Le snapshot pre-market du 27/05 confirme que les données de prix US (AAPL 47.9M, NOK 188.9M, RKLB 32.8M) sont bien récupérées, isolant AXA comme l'un des 3 tickers structurellement KO sur 26.
